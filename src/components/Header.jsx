...
function Header() {
    return (
        <section id="header">
            ...
            <h4 className="mt-4">
            Baarakallaahu Laka wa Baaraka 'Alaika Wa Jama'a Bainakumaa Fee Khair
                <br />
                Allaah Tumahaare Zindagi mei Barkat de Aur Tum Dono ko Bhalayi ke Sath Zindagi Guzarne ki Taufeeq de - Aameen
            </h4>
