                    ...
                    <>
                        <div className="row">
                            ...
                            >
                                <h1>Nikaah</h1>
                                <p>
                                    On Sunday, 22<sup>nd</sup> October, 2023,
                                    <br />
                                    06<sup>th</sup> Rabi-us-Sani, 1445 Hijri,
                                    <br />
                                    Time: 12:30 PM.
                                </p>
                        ...
                        <div className="row">
                            ...
                            >
                                <h1>Valima</h1>
                                <p>
                                    On Tuesday, 24<sup>th</sup> October, 2023,
                                    <br />
                                    08<sup>th</sup> Rabi-us-Sani, 1445 Hijri,
                                    <br />
                                    Time: 02:00 PM.
                                </p>
                                <h2>Venue:</h2>
                                <p>
                                    ...
                                    <br /> Beside St. Joseph Boys School,
                                    <br /> C.B., Bellari.
                                </p>
                            </div>
                        </div>
